    ...
    run: async (interaction, client) => {
        ...
        if (interaction.isButton()) {
                    ...
                    if (status === false) {
                        ...
                        setTimeout(() => {
                            ...
                            interaction.editReply({
                                embeds: [
                                    new EmbedBuilder()
                                        .setDescription(' Você não autorizou durante 5 Minutos, tente novamente!')
                                ],
                                components: [fernandinhaa]
                            })
            ...
            if (interaction.customId == 'configurarmercadopago') {
                ...
                const lucas = new ActionRowBuilder()
                .addComponents(

            new ButtonBuilder()
                .setCustomId("infobancos")
                .setLabel('Informações Bancos')
                .setEmoji(`1240095676986163231`)
                .setStyle(1)
                .setDisabled(false),
                ...
                interaction.update({ embeds: [], components: [lucas, fernandona, voltar], content: `Oque deseja configurar?` })


            }


            if (interaction.customId == 'infobancos') {
                const banklist = {
